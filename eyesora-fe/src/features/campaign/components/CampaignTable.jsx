                    ...
                    <tr key={c.campaignId} className="hover:bg-gray-50 transition-colors group">
                        ...
                        <td className="px-6 py-4 text-right flex justify-end gap-2">
                            <button
                                ...
                                className="p-2 bg-white border border-gray-200 rounded-lg text-gray-500 hover:text-blue-900 transition-all shadow-sm"
                            >
                                <Eye size={16}/>
                            </button>
                            <button
                            ...
                            <button
                                ...
                                className="p-2 bg-white border border-gray-200 rounded-lg text-gray-500 hover:text-gray-900 transition-all shadow-sm"
                            >
                                {c.status === 'LOCKED' ? <Unlock size={16}/> : <Lock size={16}/>}
                            </button>
                            <button
                                onClick={() => onDelete(c.campaignId)}
                                className="p-2 bg-white border border-gray-200 rounded-lg text-gray-500 hover:text-red-600 transition-all shadow-sm"
                            >
                                <Trash2 size={16}/>
                            </button>
                        </td>
