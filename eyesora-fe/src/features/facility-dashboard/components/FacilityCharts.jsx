...
const FacilityCharts = ({ gradeStats, timelineStats, animateBars, path, circles }) => {
    return (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            {/* 1. Biểu đồ Tỷ lệ cận thị theo khối lớp */}
            ...
            {/* 2. Biểu đồ Xu hướng cận thị qua các năm */}
                ...
                <div className="relative h-64 w-full pt-4">
                    {timelineStats && timelineStats.length > 0 ? (
                        ...
                        <div className="h-full flex items-center justify-center border border-dashed border-gray-200 rounded-xl text-xs text-gray-400 italic">
                            Cơ sở giáo dục được chọn chưa có dữ liệu dòng thời gian xu hướng
                        </div>
                    )}
                </div>
            </div>
