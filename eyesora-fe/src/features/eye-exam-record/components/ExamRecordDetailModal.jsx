            ...
            <div className="bg-white p-8 rounded-3xl w-full max-w-2xl shadow-2xl overflow-y-auto max-h-[90vh]">
                ...
                <div className="grid grid-cols-2 gap-4 bg-gray-50 p-4 rounded-xl mb-6 text-sm">
                    ...
                    <div>
                        ...
                        <span className="font-bold text-gray-950">{record.className || "-"}</span>
                    </div>

                    <div className="col-span-2">
                        <span className="text-gray-500 font-medium">Trường học: </span>
                        <span className="font-bold text-gray-950">{record.facilityName || "-"}</span>
                    </div>

                    <div>
                        <span className="text-gray-500 font-medium">Ngày khám: </span>
                        <span className="font-bold text-gray-950">{formatDate(record.examDate)}</span>
                    </div>

                    <div className="col-span-2">
                        <span className="text-gray-500 font-medium">Chiến dịch: </span>
                        <span className="font-bold text-gray-950">{record.campaignTitle || "-"}</span>
                    </div>

                    <div className="col-span-2">
                        <span className="text-gray-500 font-medium">Người khám: </span>
                        <span className="font-bold text-gray-950">{record.examinerName || "-"}</span>
                    </div>
                </div>
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="flex justify-between border-b border-gray-100 pb-2">
                                ...
                                <span className="text-sm font-black text-blue-900">
                                    {formatVA(record.vaLeftWithoutGlasses)}
                                </span>
                            </div>
                            ...
                            <div className="flex justify-between border-b border-gray-100 pb-2">
                                ...
                                <span className="text-sm font-black text-blue-900">
                                    {formatVA(record.vaLeftOldGlasses)}
                                </span>
                            </div>
                            ...
                            <div className="flex justify-between border-b border-gray-100 pb-2">
                                ...
                                <span className="text-sm font-black text-blue-900">
                                    {formatVA(record.vaLeftWithGlasses)}
                                </span>
                            </div>
                        ...
                        <div className="space-y-3">
                            <div className="flex justify-between border-b border-gray-100 pb-2">
                                ...
                                <span className="text-sm font-black text-green-900">
                                    {formatVA(record.vaRightWithoutGlasses)}
                                </span>
                            </div>
                            ...
                            <div className="flex justify-between border-b border-gray-100 pb-2">
                                ...
                                <span className="text-sm font-black text-green-900">
                                    {formatVA(record.vaRightOldGlasses)}
                                </span>
                            </div>
                            ...
                            <div className="flex justify-between border-b border-gray-100 pb-2">
                                ...
                                <span className="text-sm font-black text-green-900">
                                    {formatVA(record.vaRightPinhole)}
                                </span>
                            </div>
                            ...
                            <div className="flex justify-between border-b border-gray-100 pb-2">
                                ...
                                <span className="text-sm font-black text-green-900">
                                    {formatVA(record.vaRightWithGlasses)}
                                </span>
                            </div>
